...
import io.chrisdavenport.ancientconcurrent.internal.TrampolineEC.JVMTrampoline
 ...
 */
final private[ancientconcurrent] class TrampolineEC private (underlying: ExecutionContext) extends ExecutionContext {
...
private[ancientconcurrent] object TrampolineEC {
