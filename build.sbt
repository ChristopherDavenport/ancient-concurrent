...
lazy val site = project.in(file("site"))
  ...
  .settings{
    import microsites._
    Seq(
      micrositeName := "ancient-concurrent",
      micrositeDescription := "Cats-Effect Concurrency For Ancient Times",
      micrositeAuthor := "Christopher Davenport",
      micrositeGithubOwner := "ChristopherDavenport",
      micrositeGithubRepo := "ancient-concurrent",
      micrositeBaseUrl := "/ancient-concurrent",
      micrositeDocumentationUrl := "https://www.javadoc.io/doc/io.chrisdavenport/ancient-concurrent_2.12",
...
lazy val commonSettings = Seq(
  ...
  libraryDependencies ++= Seq(
    ...
    "org.scalatestplus"           %% "scalatestplus-scalacheck"   % scalatestplusScalacheckV % Test
  ),
  scalacOptions --= Seq(
    "-Ywarn-value-discard",
    "-Xfatal-warnings"
...
inThisBuild(List(
  ...
  scalacOptions in (Compile, doc) ++= Seq(
      ...
      "-doc-source-url", "https://github.com/ChristopherDavenport/ancient-concurrent/blob/v" + version.value + "€{FILE_PATH}.scala"
  )
))